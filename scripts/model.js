/**
 * backbone model definitions for SISTEMA_IGCAR
 */
...
/**
 * ClientePf Backbone Model
 */
model.ClientePfModel = Backbone.Model.extend({
	urlRoot: 'api/clientepf',
	idAttribute: 'id',
	id: '',
	razaoSocial: '',
	email: '',
...
/**
 * ClientePf Backbone Collection
 */
model.ClientePfCollection = model.AbstractCollection.extend({
	url: 'api/clientepfs',
	model: model.ClientePfModel
});

/**
 * ClientePj Backbone Model
 */
model.ClientePjModel = Backbone.Model.extend({
	urlRoot: 'api/clientepj',
	idAttribute: 'id',
	id: '',
	nomeCompleto: '',
	email: '',
...
/**
 * ClientePj Backbone Collection
 */
model.ClientePjCollection = model.AbstractCollection.extend({
	url: 'api/clientepjs',
	model: model.ClientePjModel
});
...
/**
 * Veiculo Backbone Model
 */
model.VeiculoModel = Backbone.Model.extend({
	urlRoot: 'api/veiculo',
	idAttribute: 'id',
	id: '',
	placa: '',
...
/**
 * Veiculo Backbone Collection
 */
model.VeiculoCollection = model.AbstractCollection.extend({
	url: 'api/veiculos',
	model: model.VeiculoModel
});
