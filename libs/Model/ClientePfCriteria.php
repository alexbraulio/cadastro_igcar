...
require_once("DAO/ClientePfCriteriaDAO.php");

/**
 * The ClientePfCriteria class extends ClientePfDAOCriteria and is used
 ...
 * @version 1.0
 */
class ClientePfCriteria extends ClientePfCriteriaDAO
{
