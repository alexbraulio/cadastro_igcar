...
require_once("DAO/ServicoCriteriaDAO.php");

/**
 * The ServicoCriteria class extends ServicoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ServicoCriteria extends ServicoCriteriaDAO
{
