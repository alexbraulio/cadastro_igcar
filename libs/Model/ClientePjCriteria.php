...
require_once("DAO/ClientePjCriteriaDAO.php");

/**
 * The ClientePjCriteria class extends ClientePjDAOCriteria and is used
 ...
 * @version 1.0
 */
class ClientePjCriteria extends ClientePjCriteriaDAO
{
