...
require_once("DAO/VeiculoCriteriaDAO.php");

/**
 * The VeiculoCriteria class extends VeiculoDAOCriteria and is used
 ...
 * @version 1.0
 */
class VeiculoCriteria extends VeiculoCriteriaDAO
{
