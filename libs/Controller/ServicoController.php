...
class ServicoController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Id,Placa,Servico,Descricao,Valor'
				, '%'.$filter.'%')
			);
	...
	public function Update()
	{
		try
		{
			...
			$servico->Placa = $this->SafeGetVal($json, 'placa', $servico->Placa);
			$servico->Servico = $this->SafeGetVal($json, 'servico', $servico->Servico);
